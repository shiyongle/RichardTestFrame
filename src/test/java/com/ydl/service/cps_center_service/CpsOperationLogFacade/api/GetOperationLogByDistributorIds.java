 ...
 * Description:
 */
public class GetOperationLogByDistributorIds {
    public Response get(int distributorId){
        return given()
                .queryParam("distributorId", distributorId)
                .contentType(ContentType.JSON)
                .when().log().all()
                .post("http://47.96.181.183:10088/h/com.ydl.wo.intf.facade.CpsOperationLogFacade/getOperationLogByDistributorIds")
                .then().log().all()
